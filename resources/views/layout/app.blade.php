    ...
    <div id="app">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Cari elemen tabel berdasarkan ID yang kita berikan
                let tableCutiQuota = document.querySelector('#tableCutiQuota');
                if (tableCutiQuota) {
                    // Inisialisasi Simple DataTables
                    new simpleDatatables.DataTable(tableCutiQuota);
                }

                // Tambahkan event listener untuk form update di dalam datatables (jika perlu interaksi khusus)
                // Biasanya tidak perlu jika hanya submit form biasa
            });
        </script>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
