{{-- resources/views/emails/cuti/status_notification.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        /* Styling dasar email (sama seperti lembur) */
        ...
        .detail-table td.label { font-weight: bold; width: 150px; }
...
<body>
    <div class="email-container">
        ...
        <div class="content-block">
            @if ($status === 'approved')
                <p>Dengan senang hati kami memberitahukan bahwa pengajuan cuti Anda telah <strong>disetujui</strong>.</p>
            @elseif ($status === 'rejected')
                <p>Dengan berat hati kami memberitahukan bahwa pengajuan cuti Anda telah <strong>ditolak</strong>.</p>
            @else
                <p>Ada pembaruan status untuk pengajuan cuti Anda.</p> {{-- Fallback --}}
            @endif
        </div>

        <div class="content-block">
            <p>Berikut adalah rincian pengajuan cuti Anda:</p>
            <table class="detail-table">
                ...
                {{-- Anda bisa tambahkan Keperluan jika perlu --}}
                {{-- <tr>
