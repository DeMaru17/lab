    ...
    <div id="main">
                        ...
                        <div class="row gy-2">
                            ...
                            @if (Auth::user()->role === 'admin' || Auth::user()->role === 'manajemen')
                                <div class="col-md-3 col-12">
                                    ...
                                    <select name="filter_user_id" id="filter_user_id"
                                        class="form-select form-select-sm select2"> {{-- Tambahkan kelas select2 jika digunakan --}}
                            ...
                            <div class="col-md-12 d-flex align-items-end mt-2">
                                <button type="submit" class="btn btn-primary btn-sm me-1"><i class="bi bi-filter"></i>
                                    Filter</button>
                                <a href="{{ route('monthly_timesheets.index') }}" class="btn btn-light-secondary btn-sm"><i
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8 col-12">
                            ...
                            @endif
                            {{-- Tampilkan periode filter jika filter aktif --}}
                            ...
                            @elseif ($hasFiltered && Auth::user()->role === 'personil')
                                {{-- Jika personil dan sudah filter (meskipun mungkin default bulan lalu), tampilkan periode defaultnya --}}
                ...
                <div class="card-body">
                    @if ($hasFiltered)
                        {{-- Hanya tampilkan tabel jika filter sudah diterapkan --}}
                        ...
                        <div class="mt-3">
                            {{-- Pastikan $timesheets adalah instance Paginator --}}
                            @if ($timesheets instanceof \Illuminate\Pagination\AbstractPaginator)
                    ...
                    @else
                        <div class="alert alert-info text-center">
                            ...
                            Silakan gunakan filter di atas untuk menampilkan data timesheet.
                        </div>
                    @endif
                </div>
            </div>
...
@push('js')
    ...
    {{-- Jika menggunakan select2, uncomment dan pastikan jQuery sudah ada --}}
    {{-- <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script>
        $(document).ready(function() {
            $('.select2').select2({ theme: 'bootstrap-5' }); // Gunakan tema bootstrap-5 jika tersedia
        });
    </script> --}}
@endpush

@push('styles')
    {{-- Jika menggunakan select2, uncomment --}}
