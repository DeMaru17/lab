                            ...
                            @if (Auth::user()->role === 'admin' || Auth::user()->role === 'manajemen')
                                <div class="col-md-3 col-12">
                                    ...
                                    <select name="filter_user_id" id="filter_user_id"
                                        class="form-select form-select-sm select2"> {{-- form-select-sm & select2 --}}
                            ...
                            <tbody>
                                @forelse ($timesheets as $timesheet)
                                    <tr>
                                        ...
                                        <td class="text-nowrap">{{ $timesheet->period_start_date->format('d/m/y') }} -
                                        ...
                                        <td class="text-center">
                                            ...
                                            @php
                                                ...
                                                switch ($timesheet->status) {
                                                    case 'generated':
                                                        $statusClass = 'bg-light-secondary text-dark';
                                                        break; // Warna beda untuk generated
                                            ...
                                            @if ($timesheet->status == 'rejected' && $timesheet->rejecter)
                                                <i class="bi bi-info-circle-fill text-danger" data-bs-toggle="tooltip"
                                                    title="Ditolak oleh: {{ $timesheet->rejecter->name }} | Alasan: {{ Str::limit($timesheet->notes, 50) }}"></i>
                                ...
                                @empty
                                    <tr>
                                        {{-- Sesuaikan colspan --}}
                                        <td colspan="9" class="text-center">Tidak ada data timesheet yang cocok dengan
                                            filter Anda.</td>
                                    </tr>
                                @endforelse
                            </tbody>
